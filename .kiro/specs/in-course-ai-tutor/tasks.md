...
- [x] 1. Branch + tool schemas for connection/movement
...
- [x] 3. Implement the three new tools
...
- [x] 4. Carry component label through `add_component`
...
- [x] 7. Course-aware system prompt builder
...
- [x] 8. Ephemeral course session (seed / collect / discard)
...
- [x] 11. Frontend API client + types
...
- [x] 13. TutorChat panel + mutation application
...
- [x] 14. Mount TutorChat in the level player
...
- [x] 15. Property tests for wire-tool invariants + full verification
