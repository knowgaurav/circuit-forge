...
class LevelContent(BaseModel):
    ...
    theory: Optional[TheorySection] = None
    practical: Optional[PracticalSection] = None

    generated_at: Optional[datetime] = Field(default=None, alias="generatedAt")
    token_usage: Optional[int] = Field(default=None, alias="tokenUsage")
...
class GeneratePlanRequest(BaseModel):
    """Request to generate a course plan."""
